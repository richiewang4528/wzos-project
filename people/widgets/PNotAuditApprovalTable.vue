        ...
        <el-table
            ...
            <div class="td-wrapper">
                <el-table-column 
                    ...
                    width="160">
                    <template slot-scope="scope">
                        <el-button  @click="changeReason(scope.row)" type="warning" size="mini">修改原因</el-button>
                    </template>
                </el-table-column>
            </div>
        </el-table>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            keyPeopleList(){
                return this.$store.getters.getAuditapprovalPeopleList
            }
        },
        mounted(){
            let pageOption = this.$store.getters.getNoTaskPageOption
        ...
        methods: {
            ...
            loadDataCallBack(data, flag){
                this.loading = false
                if(data && data.result){
                    this.$store.commit('set_auditapproval_people_list', data)
                }
                if(data.code === 200){
            ...
            handleChange(){
                this.$store.commit('set_notask_pageoption', {page:this.page, pageLimit:this.pageLimit})
