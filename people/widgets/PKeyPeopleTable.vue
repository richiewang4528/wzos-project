...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            keyPeopleList(){
                return this.$store.getters.getKeyPeopleList
            }
        },
        mounted(){
            let pageOption = this.$store.getters.getKeyPageOption
        ...
        methods: {
            ...
            handleChange(){
                this.$store.commit('set_key_pageoption', {page:this.page, pageLimit:this.pageLimit})
