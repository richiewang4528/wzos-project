...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            keyPeopleList(){
                return this.$store.getters.getAssignPeopleList
            }
        },
        mounted(){
            let pageOption = this.$store.getters.getNoAssignPageOption
        ...
        methods: {
            ...
            loadDataCallBack(data, flag){
                this.loading = false
                if(data && data.result){
                    this.$store.commit('set_assign_people_list', data)
                }
                if(data.code === 200){
            ...
            handleChange(){
                this.$store.commit('set_noassign_pageoption', {page:this.page, pageLimit:this.pageLimit})
