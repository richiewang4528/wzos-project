...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            keyPeopleList(){
                return this.$store.getters.getAssignedPeopleList
            }
        },
        mounted(){
            let pageOption = this.$store.getters.getAssignPageOption
        ...
        destroyed(){
            ...
            // this.$store.commit('set_assigned_people_list', [])  
            // this.$store.commit('set_custom_column', [])
        },
        methods: {
            ...
            loadDataCallBack(data, flag){
                this.loading = false
                if(data && data.result){
                    this.$store.commit('set_assigned_people_list', data)
                }
                if(data.code === 200){
            ...
            handleChange(){
                this.$store.commit('set_assign_pageoption', {page:this.page, pageLimit:this.pageLimit})
