...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            keyPeopleList(){
                return this.$store.getters.getApprovalPeopleList
            }
        },
        mounted(){
            let pageOption = this.$store.getters.getTask2PageOption
        ...
        methods: {
            ...
            loadDataCallBack(data, flag){
                this.loading = false
                if(data && data.result){
                    this.$store.commit('set_approval_people_list', data)
                }
                if(data.code === 200){
            ...
            handleChange(){
                this.$store.commit('set_task2_pageoption', {page:this.page, pageLimit:this.pageLimit})
